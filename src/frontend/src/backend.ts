...
import type { ChecklistItem as _ChecklistItem, ExternalBlob as _ExternalBlob, StoreChecklistEntry as _StoreChecklistEntry, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createChecklistEntry(arg0: string, arg1: Array<ChecklistItem>): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createChecklistEntry(arg0, await to_candid_vec_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ChecklistItem_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ChecklistItem): Promise<ChecklistItem> {
...
async function from_candid_StoreChecklistEntry_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StoreChecklistEntry): Promise<StoreChecklistEntry> {
...
async function from_candid_opt_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StoreChecklistEntry]): Promise<StoreChecklistEntry | null> {
    return value.length === 0 ? null : await from_candid_StoreChecklistEntry_n15(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StoreChecklistEntry>): Promise<Array<StoreChecklistEntry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_StoreChecklistEntry_n15(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ChecklistItem>): Promise<Array<ChecklistItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ChecklistItem_n18(_uploadFile, _downloadFile, x)));
}
async function to_candid_ChecklistItem_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ChecklistItem): Promise<_ChecklistItem> {
...
async function to_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<ChecklistItem>): Promise<Array<_ChecklistItem>> {
    return await Promise.all(value.map(async (x)=>await to_candid_ChecklistItem_n11(_uploadFile, _downloadFile, x)));
}
